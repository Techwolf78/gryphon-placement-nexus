...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-slate-50 via-white to-violet-50/30">
          ...
          >
            <Box className="mb-8">
              <Chip 
                ...
                label="AI-Powered CRM Revolution"
                variant="outlined"
                className="mb-8 bg-gradient-to-r from-violet-100 to-cyan-100 border-violet-200 text-violet-700"
              />
            </Box>
            ...
            <Typography
              variant="h1"
              component="h1"
              className="mb-8 bg-gradient-to-r from-slate-900 via-violet-900 to-slate-900 bg-clip-text text-transparent"
            >
              Transform Your
              <br />
            ...
            <Typography
              variant="h6"
              component="p"
              className="mb-12 text-slate-600 max-w-2xl font-light leading-relaxed"
            >
              Gryphon Academy CRM leverages cutting-edge AI to revolutionize how educational 
              institutions manage placements, connect with employers, and track student success.
            </Typography>

            <Box className="flex flex-col sm:flex-row gap-6 mb-16">
              <Button 
                size="lg"
                className="group bg-gradient-to-r from-violet-600 via-purple-600 to-cyan-600 text-white hover:shadow-2xl"
              >
                Start Free Trial
                <motion.span 
                  className="ml-2"
            ...
            {/* Stats section with Material-UI */}
            <Box className="grid grid-cols-3 gap-8">
              {[
                { icon: TrendingUp, value: '40%', label: 'Higher Success Rate' },
                { icon: Users, value: '500+', label: 'Institutions Trust Us' },
                ...
                >
                  <Card useMui className="text-center p-4 bg-white/60 backdrop-blur-sm">
                    <CardContent useMui>
                      <stat.icon className="w-8 h-8 mx-auto mb-2 text-violet-600" />
                      <Typography variant="h4" component="div" className="font-bold text-slate-900">
                        {stat.value}
                      </Typography>
